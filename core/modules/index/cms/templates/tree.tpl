<div class="ui-widget ui-corner-all main-content" style="width: 900px;">
    ...
    {foreach item=list name=list from=$project_list}
        <div class="list-row">
            ...
            <span class="edit-set">
                <button class="button-edit" onclick="document.location.href = '/{$router->getUrl('cms','index','edit',$tree.project_id)}'">edytuj</button>
                <button class="button-delete" title="delete" value="{$tree.project_id}">usuń</button>
            </span>
            <span class="move-set">
                <button class="button-move-down" title="DOWN" value="{$tree.project_id}">przesuń w dół</button>
                <button class="button-move-up" title="UP" value="{$tree.project_id}">przesuń w górę</button>
            </span>
